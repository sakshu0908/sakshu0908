...
🔗 [View Project](https://github.com/sakshu0908/customer-churn-prediction)
### 👩‍💻 Face Recognition Attendance System
A face recognition-based attendance system developed using Python and Computer Vision concepts.
🔗 [View Project](https://github.com/sakshu0908/attendance-management-system-using-face-recognition)
### 🔥 AI Fraud Detection
A machine learning project developed to detect fraudulent transactions using classification techniques.
🔗 [View Project](https://github.com/sakshu0908/fraud-detection)
### 🌐 Personal Portfolio
